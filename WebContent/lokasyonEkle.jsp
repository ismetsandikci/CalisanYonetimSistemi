				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="active treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							...
							<li class="active"><a href="lokasyonEkle.jsp"><i
									class="fa-plus-square"></i> Lokasyon Ekle</a></li>
						</ul></li>
				</ul>
			</section>
			<!-- /.sidebar -->
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Lokasyon Ekle</li>
				</ol>
			</section>
            ...
            if((kullaniciyaMesaj!="") || (kullaniciyaMesaj==null)){
            	if(kullaniciyaMesaj.equals("Lokasyon Eklendi.")){
            	...
            	else if((kullaniciyaMesaj.equals("Aynı bilgilerle Lokasyon kaydı var.")) || (kullaniciyaMesaj.equals("Lokasyon Eklenemedi."))){
            ...
            %>
							<!-- form start -->
							<form role="form" action="lokasyonEkle.jsp" method="post"
								id="lokasyonEkleForm" name="lokasyonEkleForm">
								<div class="box-body">
...
String lokasyonadi = request.getParameter("lokasyonAd");
String lokasyonadresi = request.getParameter("lokasyonAdresi");
String lokasyonpostakodu = request.getParameter("lokasyonPostaKodu");
...
if ((lokasyonadi != null) && (lokasyonadresi != null) && (lokasyonpostakodu != null) && (lokasyonsehir != null) && (lokasyoulke != null)) {
	...
	try {
		if (calisanId != null) {
			...
			ResultSet rs101 = stmt.executeQuery("SELECT * FROM lokasyon where lokasyonadi='" + lokasyonadi + "' AND lokasyonadresi='" + lokasyonadresi + "' AND lokasyonpostakodu='" + lokasyonpostakodu + "' AND lokasyonsehir='" + lokasyonsehir + "' AND lokasyoulke='" + lokasyoulke + "'");
			if(rs101.next()){
				System.out.println("\nAynı bilgilerle Lokasyon kaydı var.");
				session.setAttribute("kullaniciyaMesaj", "Aynı bilgilerle Lokasyon kaydı var.");
				response.sendRedirect("departmanEkle.jsp");
			}
			else{
				List<Integer> idList = new ArrayList<Integer>();
				ResultSet rs11 = stmt.executeQuery("SELECT * FROM lokasyon");
				while(rs11.next()){
					idList.add(rs11.getInt("lokasyonid"));
				}
				rs11.close();
				int maxId = Collections.max(idList);
				maxId=maxId+1;
				
				int lokasyonEkle = stmt.executeUpdate(
						"INSERT INTO lokasyon (lokasyonid,lokasyonadi,lokasyonadresi,lokasyonpostakodu,lokasyonsehir,lokasyoulke) VALUES ('"+ maxId + "','"+ lokasyonadi + "','" + lokasyonadresi + "','" + lokasyonpostakodu + "','"+ lokasyonsehir + "','"+ lokasyoulke + "');");
				if (lokasyonEkle == 1) {
					System.out.println("\nLokasyon Eklendi");
					session.setAttribute("kullaniciyaMesaj", "Lokasyon Eklendi.");
					response.sendRedirect("lokasyonEkle.jsp");
				}
				else{
					System.out.println("\nLokasyon Eklenemedi");
					session.setAttribute("kullaniciyaMesaj", "Lokasyon Eklenemedi");
					response.sendRedirect("lokasyonEkle.jsp");
				}
	} 
		}else {
		...
		System.err.println("DB Bağlantı Hatası! lokasyonEkle");
		System.err.println(a.getMessage());
	}
}
%>